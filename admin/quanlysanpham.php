...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES["image"]) && $_FILES["image"]["error"] == 0) {
        // Sinh tên file duy nhất tránh trùng lặp đè file
        $fileName = basename($_FILES["image"]["name"]);
        // Lấy phần mở rộng
        $imageFileType = strtolower(pathinfo($fileName, PATHINFO_EXTENSION));
        // Đổi tên file: timestamp_filename.ext
                ...
                <tbody>
                    <?php foreach ($products as $p): ?>
                        <tr>
                            ...
                            <td>
                                <?php if ($p['Count'] > 10): ?>
                                    <span class="badge bg-success bg-opacity-10 text-success border border-success"><?= $p['Count'] ?></span>
                                <?php elseif ($p['Count'] > 0): ?>
                                    <span class="badge bg-warning bg-opacity-10 text-warning border border-warning"><?= $p['Count'] ?></span>
                                <?php else: ?>
...
<div class="modal fade" id="productModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="index.php?act=quanlysanpham" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <small class="text-muted" id="imageHelp">Chọn ảnh tải lên. Nếu đang sửa, để trống để giữ ảnh cũ.</small>
                        </div>

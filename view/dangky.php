    ...
    <div class="card shadow-sm border-0" style="max-width: 450px; width: 100%; border-radius: 12px;">
        <div class="card-body p-5">
            ...
            <div class="text-center mt-4 pt-3 border-top">
                <p class="font-label-sm text-muted mb-0">Đã có tài khoản? <a href="<?= BASE_URL ?>index.php?act=login" class="text-primary-custom text-decoration-none fw-bold">Đăng nhập ngay</a></p>
            </div>
        </div>
    </div>
</div>
